---
title: 2018 Liceo Scientifico — Problema 1 — Problema 1
tipo: problema
item_id: prob_2018_liceo_scientifico_2018_problema1_6_1
...
**Prova:** [[Prove/2018_liceo_scientifico_2018_problema1_6|2018 Liceo Scientifico — Problema 1]] · **Cluster:** [[Clusters/Studio di Funzione|Studio di Funzione]]
...
**3)** Verifica che al variare di $n$ tutte queste funzioni rispettano le condizioni a), b) e c). Dette $A_n$ e $B_n$ le aree delle parti colorate delle mattonelle ottenute a partire da tali funzioni $a_n$ e $b_n$, calcola

$$\lim_{n \to +\infty} A(n) \quad \text{e} \quad \lim_{n \to +\infty} B(n)$$
...
**Soluzione:** [[Svolgimenti/sol_prob_2018_liceo_scientifico_2018_problema1_6_1|📝 Svolgimento]] · [📄 PDF p.6](https://drive.google.com/file/d/1vt-OZDFhSWqupGghcan_yIZCMQ0DrJTR/view)
