---
title: 2019 Boreale — Problema 2 — Problema 1
tipo: problema
item_id: prob_2019_boreale_2019_problema2_74_1
...
**Prova:** [[Prove/2019_boreale_2019_problema2_74|2019 Boreale — Problema 2]] · **Cluster:** [[Clusters/Studio di Funzione|Studio di Funzione]]
...
a) Determinare le unità di misura della costante $k$. Verificare che, in questo modello, l'accelerazione istantanea del corpo è espressa dalla funzione
...
b) Dopo aver verificato che l'accelerazione è decrescente e tende a 0 al trascorrere del tempo, fornire un'interpretazione fisica della situazione fin qui descritta. Posto $h=\sqrt{\frac{mg}{k}}$ e $b=2\sqrt{\frac{kg}{m}}$, dove $m$ indica la massa del corpo e $g$ l'accelerazione di gravità, verificare che viene rispettato il 2° principio della dinamica. Dedurre, da quanto posto, che $h$ e $b$ hanno, rispettivamente, le dimensioni di una velocità e del reciproco di un tempo.

c) Tracciare, indipendentemente dalla situazione fisica, il grafico $\Gamma$ della funzione $v(t)$ per $t\in\mathbb{R}$, specificandone la simmetria. Dedurre da esso, in modo qualitativo, il grafico della sua primitiva passante per il punto $\left(0;\frac{2h}{b}\ln 2\right)$. In particolare, stabilire se la primitiva ammette asintoti obliqui e, in caso affermativo, scriverne le equazioni, sempre considerando che, per $t\to+\infty$, si può ricorrere all'approssimazione $1+e^{bt}\simeq e^{bt}$.

d) Preso $t_0>0$, calcolare l'area $A$ della regione $R$ nel 1° quadrante che è delimitata dal grafico $\Gamma$, dall'asse delle ascisse e dalla retta di equazione $t=t_0$. Stabilire se, per $t_0\to+\infty$, l'area $A$ tende o meno ad un valore finito. Infine, preso $\tau>0$, calcolare il valore dell'integrale
$$\int_{-\tau}^{\tau}a(t)\,dt$$
...
**Soluzione:** [[Svolgimenti/sol_prob_2019_boreale_2019_problema2_74_1|📝 Svolgimento]] · [📄 PDF p.74](https://drive.google.com/file/d/1ojz6PRWkAmZwQqGOBNvRb7lmy8wfykkO/view)
