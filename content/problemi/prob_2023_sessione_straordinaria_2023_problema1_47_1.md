---
title: 2023 Straordinaria — Problema 1 — Problema 1
tipo: problema
item_id: prob_2023_sessione_straordinaria_2023_problema1_47_1
...
**Prova:** [[Prove/2023_sessione_straordinaria_2023_problema1_47|2023 Straordinaria — Problema 1]] · **Cluster:** [[Clusters/Studio di Funzione|Studio di Funzione]]
...
**c)** Si consideri la funzione $g(x) = 2 - \dfrac{3}{x}$ e verificare che, $\forall x > 0$, vale la disuguaglianza $f_n(x) > g(x)$ indipendentemente dal valore di $n$. Si consideri l'integrale

$$I(t) = \int_1^t \left(f_n(x) - g(x)\right)dx$$

che esprime l'area della regione delimitata dai grafici delle funzioni $f_n$ e $g$ e dalle rette di equazioni $x = 1$ e $x = t$, $t > 1$. Si calcolino $I(t)$ e il $\lim\limits_{t \to +\infty} I(t)$, fornendo un'interpretazione geometrica del risultato ottenuto.
...
**Soluzione:** [[Svolgimenti/sol_prob_2023_sessione_straordinaria_2023_problema1_47_1|📝 Svolgimento]] · [📄 PDF p.47](https://drive.google.com/file/d/1SlPvapgs-eNHrpZYtGGUXCPHVcacwdKR/view)
