---
tipo: prova
prova_id: prova_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82
anno: '2007'
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_2|Quesito 2]]*

**Quesito 2.** Le misure dei lati di un triangolo sono $40$, $60$ e $80$ cm. Si calcolino, con l'aiuto di una calcolatrice, le ampiezze degli angoli del triangolo approssimandole in gradi e primi sessagesimali.
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_3|Quesito 3]]*

**Quesito 3.** Si scelga a caso un punto $P$ all'interno di un triangolo equilatero il cui lato ha lunghezza $3$. Si determini la probabilità che la distanza di $P$ da ogni vertice sia maggiore di $1$.
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_4|Quesito 4]]*

**Quesito 4.** Un serbatoio di olio ha la stessa capacità del massimo cono circolare retto di apotema $1$ metro. Si dica quanti litri di olio il serbatoio può contenere.
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_5|Quesito 5]]*

**Quesito 5.** Si mostri che la funzione $y=x^3+8$ soddisfa le condizioni del teorema del valor medio (o teorema di Lagrange) sull'intervallo $[-2,2]$. Si determinino i valori medi forniti dal teorema e se ne illustri il significato geometrico.
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_6|Quesito 6]]*

**Quesito 6.** Si sa che il prezzo $p$ di un abito ha subìto una maggiorazione del $6\%$ e, altresì, una diminuzione del $6\%$; non si ha ricordo, però, se sia avvenuta prima l'una o l'altra delle operazioni. Che cosa si può dire del prezzo finale dell'abito?
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_7|Quesito 7]]*

**Quesito 7.** Se $f(x)$ è una funzione reale dispari (ossia il suo grafico cartesiano è simmetrico rispetto all'origine), definita e integrabile nell'intervallo $[-2,2]$, che dire del suo integrale esteso a tale intervallo? Quanto vale nel medesimo intervallo l'integrale della funzione $3+f(x)$?
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_8|Quesito 8]]*

**Quesito 8.** A Leonardo Eulero (1707-1783), di cui quest'anno ricorre il terzo centenario della nascita, si deve il seguente problema: «Tre gentiluomini giocano insieme: nella prima partita il primo perde, a favore degli altri due, tanto denaro quanto ne possiede ciascuno di loro. Nella successiva, il secondo gentiluomo perde a favore di ciascuno degli altri due tanto denaro quanto essi già ne possiedono. Da ultimo, nella terza partita, il primo e il secondo guadagnano ciascuno dal terzo gentiluomo tanto denaro quanto ne avevano prima. A questo punto smettono e trovano che ciascuno ha la stessa somma, cioè $24$ luigi. Si domanda con quanto denaro ciascuno si sedette a giocare».
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_9|Quesito 9]]*

**Quesito 9.** Si risolva l'equazione $4\dbinom{n}{4}=15\dbinom{n-2}{3}$.
...
*↳ Nota atomica: [[Quesiti/ques_2007_liceo_della_comunicazione_2007_sessione_ordinaria_questionario_82_10|Quesito 10]]*

**Quesito 10.** Per orientarsi sulla Terra si fa riferimento a meridiani e a paralleli, a latitudini e a longitudini. Supponendo che la Terra sia una sfera $S$ e che l'asse di rotazione terrestre sia una retta $r$ passante per il centro di $S$, come si può procedere per definire in termini geometrici meridiani e paralleli e introdurre un sistema di coordinate geografiche terrestri?
