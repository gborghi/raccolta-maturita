...
*↳ Nota atomica: [[Problemi/prob_2003_sessione_ordinaria_2003_211_n_03_prova_181_1|Problema 1]]*

Nel piano sono dati: il cerchio $\gamma$ di diametro $OA=a$, la retta $t$ tangente a $\gamma$ in $A$, una retta $r$ passante per $O$, il punto $B$, ulteriore intersezione di $r$ con $\gamma$, il punto $C$ intersezione di $r$ con $t$. La parallela per $B$ a $t$ e la perpendicolare per $C$ a $t$ s'intersecano in $P$. Al variare di $r$, $P$ descrive il luogo geometrico $\Gamma$ noto con il nome di *versiera di Agnesi* [da Maria Gaetana Agnesi, matematica milanese, (1718–1799)].
...
2. Si verifichi che, con una opportuna scelta del sistema di coordinate cartesiane ortogonali e monometriche $Oxy$, l'equazione cartesiana di $\Gamma$ è: $y=\dfrac{a^3}{x^2+a^2}$;
...
*↳ Nota atomica: [[Problemi/prob_2003_sessione_ordinaria_2003_211_n_03_prova_181_2|Problema 2]]*

Sia $f(x)=a2^x+b2^{-x}+c$ con $a,b,c$ numeri reali. Si determinino $a,b,c$ in modo che:
...
Si calcoli $\displaystyle\int\frac{1}{g(x)}\,dx$.
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_1|Quesito 1]]*
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_2|Quesito 2]]*
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_3|Quesito 3]]*

3. Quale è la capacità massima, espressa in centilitri, di un cono di apotema $2\,\text{dm}$?
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_4|Quesito 4]]*
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_5|Quesito 5]]*
...
$$nx^{n-1}+(n-1)a_{n-1}x^{n-2}+\cdots+a_1=0$$
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_6|Quesito 6]]*
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_7|Quesito 7]]*

7. Verificare l'uguaglianza
$$\pi=4\int_0^1\frac{1}{1+x^2}\,dx$$
e utilizzarla per calcolare un'approssimazione di $\pi$, applicando un metodo di integrazione numerica.
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_8|Quesito 8]]*

8. Dare un esempio di solido il cui volume è dato da $\displaystyle\int_0^1\pi x^3\,dx$.
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_9|Quesito 9]]*

9. Di una funzione $f(x)$ si sa che ha derivata seconda uguale a $\operatorname{sen} x$ e che $f'(0)=1$. Quanto vale $\dfrac{\pi}{2}f-f(0)$?
...
*↳ Nota atomica: [[Quesiti/ques_2003_sessione_ordinaria_2003_211_n_03_prova_181_10|Quesito 10]]*
