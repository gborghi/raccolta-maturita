...
*↳ Nota atomica: [[Quesiti/ques_2007_scuole_italiane_allestero_europa_2007_sessione_ord_questionario_66_1|Quesito 1]]*

**Quesito 1.** Si calcolino le radici dell'equazione: $$5^x\cdot 3^{1-x}=10$$
...
*↳ Nota atomica: [[Quesiti/ques_2007_scuole_italiane_allestero_europa_2007_sessione_ord_questionario_66_2|Quesito 2]]*
...
*↳ Nota atomica: [[Quesiti/ques_2007_scuole_italiane_allestero_europa_2007_sessione_ord_questionario_66_3|Quesito 3]]*

**Quesito 3.** Quante cifre ha il numero $7^{60}$ nella rappresentazione decimale? Motiva esaurientemente la risposta.
...
*↳ Nota atomica: [[Quesiti/ques_2007_scuole_italiane_allestero_europa_2007_sessione_ord_questionario_66_4|Quesito 4]]*

**Quesito 4.** La formula seguente: $$e=1+\frac{1}{1!}+\frac{1}{2!}+\frac{1}{3!}+\cdots$$ è dovuta a Leonardo Eulero (1707-1783), di cui quest'anno ricorre il terzo centenario della nascita. Per dimostrarla può essere utile ricordare che è: $$\lim_{n\to\infty}\left(1+\frac{1}{n}\right)^n$$ Si illustri il ragionamento seguito.
...
*↳ Nota atomica: [[Quesiti/ques_2007_scuole_italiane_allestero_europa_2007_sessione_ord_questionario_66_5|Quesito 5]]*

**Quesito 5.** Si vuole che delle due radici reali dell'equazione $x^2+2(h+1)x+m^2h^2=0$ una risulti doppia dell'altra. Quale relazione deve sussistere tra i parametri $h$ e $m$?
...
*↳ Nota atomica: [[Quesiti/ques_2007_scuole_italiane_allestero_europa_2007_sessione_ord_questionario_66_6|Quesito 6]]*

**Quesito 6.** Il coefficiente angolare della tangente al grafico della funzione $f(x)$ è, in ogni suo punto $P$, uguale al doppio dell'ascissa di $P$. Si determini $f(x)$, sapendo che $f(0)=4$.
...
*↳ Nota atomica: [[Quesiti/ques_2007_scuole_italiane_allestero_europa_2007_sessione_ord_questionario_66_7|Quesito 7]]*

**Quesito 7.** Fra tutti i coni circolari retti circoscritti ad una sfera di raggio $r$, quello di minima area laterale ha il suo vertice distante dalla superficie sferica della quantità $r\sqrt{2}$.
...
*↳ Nota atomica: [[Quesiti/ques_2007_scuole_italiane_allestero_europa_2007_sessione_ord_questionario_66_8|Quesito 8]]*

**Quesito 8.** Si considerino un cubo e l'ottaedro regolare avente per vertici i centri delle sue facce. Si può calcolare il rapporto fra i volumi del cubo e dell'ottaedro? Si può calcolare il rapporto fra le aree del cubo e dell'ottaedro? In caso di risposta affermativa, effettuare il calcolo.
