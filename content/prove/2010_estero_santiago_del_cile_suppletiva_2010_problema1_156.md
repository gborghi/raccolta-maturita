---
tipo: prova
prova_id: prova_2010_estero_santiago_del_cile_suppletiva_2010_problema1_156
anno: '2010'
...
$$f(x)=\begin{cases} x, & \text{se } 0\le x<2 \\ x^2-6x+10, & \text{se } 2\le x\le 4 \end{cases}$$
e si dica se essa è continua e derivabile per $x=2$.

**c)** Si denoti con $S$ la regione compresa tra il grafico di $f$ e l'asse $x$ per $0\le x\le 4$. Si calcoli l'area di $S$.
