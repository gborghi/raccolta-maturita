...
*↳ Nota atomica: [[Problemi/prob_2015_sessione_ordinaria_2015_prova_108_1|Problema 1]]*
...
*↳ Nota atomica: [[Problemi/prob_2015_sessione_ordinaria_2015_prova_108_2|Problema 2]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_1|Quesito 1]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_2|Quesito 2]]*

2. Dimostrare che il volume del tronco di cono è espresso dalla formula $V=\frac{1}{3}\pi\cdot h\cdot(R^2+r^2+R\cdot r)$, dove $R$ ed $r$ sono i raggi e $h$ l'altezza.
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_3|Quesito 3]]*

3. Risolvere l'equazione $5\binom{n+1}{5}=21\binom{n-1}{4}$.
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_4|Quesito 4]]*

4. Un solido ha per base la regione $R$ del piano cartesiano compresa tra il grafico della funzione $y=\frac{1}{x^2+1}$ e l'asse delle $x$ nell'intervallo $[0,3]$. Per ogni punto $P$ di $R$, di ascissa $x$, l'intersezione del solido col piano passante per $P$ e ortogonale all'asse delle $x$ è un rettangolo di altezza $3x$. Calcolare il volume del solido.
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_5|Quesito 5]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_6|Quesito 6]]*

6. Sia $f$ la funzione, definita per tutti gli $x$ reali, da $f(x)=(x-1)^2+(x-2)^2+(x-3)^2+(x-4)^2+(x-5)^2$, determinare il minimo di $f$.
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_7|Quesito 7]]*

7. Detta $A(n)$ l'area del poligono regolare di $n$ lati inscritto in un cerchio $C$ di raggio $r$, verificare che $A(n)=\frac{n}{2}r^2\sin\frac{2\pi}{n}$ e calcolarne il limite per $n\to\infty$.
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_8|Quesito 8]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_9|Quesito 9]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_ordinaria_2015_prova_108_10|Quesito 10]]*
