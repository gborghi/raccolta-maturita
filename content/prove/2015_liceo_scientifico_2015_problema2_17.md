...
2. Individua i valori di $x$ appartenenti all'intervallo $[-3,3]$ per cui $g(x)$ ha un massimo relativo e determina i valori di $x$ per i quali $g(x)$ volge la concavità verso l'alto.

3. Calcola $g(0)$ e, se esiste, il limite

$$\lim_{x\to 0}\frac{1+g(x)}{2x}.$$

4. Sia $h(x)=3\cdot f(2x+1)$; determina il valore dell'integrale
