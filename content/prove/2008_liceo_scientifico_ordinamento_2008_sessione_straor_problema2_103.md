---
tipo: prova
prova_id: prova_2008_liceo_scientifico_ordinamento_2008_sessione_straor_problema2_103
anno: '2008'
...
*↳ Nota atomica: [[Problemi/prob_2008_liceo_scientifico_ordinamento_2008_sessione_straor_problema2_103_1|Problema 1]]*
...
**2)** Si scriva l'equazione della tangente alla curva $\gamma$ nel punto di intersezione con l'asse $y$.

**3)** Si studi la funzione $g(x) = e^{f(x)}$ e se ne tracci il grafico $\Gamma$.
