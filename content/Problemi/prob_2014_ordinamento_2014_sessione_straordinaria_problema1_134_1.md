---
title: Ordinamento 2014 Straordinaria — Problema 1 — Problema 1
tipo: problema
item_id: prob_2014_ordinamento_2014_sessione_straordinaria_problema1_134_1
prova_id: prova_2014_ordinamento_2014_sessione_straordinaria_problema1_134
anno: '2014'
...
**Prova:** [[Prove/2014_ordinamento_2014_sessione_straordinaria_problema1_134|Ordinamento 2014 Straordinaria — Problema 1]] · **Cluster:** [[Clusters/Studio di Funzione|Studio di Funzione]]
...
2. Posto $r = 1$ e $BC = x$, si calcoli il volume del solido generato dal trapezio $ABCD$, ruotando attorno ad $AB$, controllando che risulta:
$$V(x) = \frac{2}{3}\pi \cdot \frac{x^4 + x^2 + 1}{x^2}.$$
Per quali valori di $x$, $V(x)$ ammette un massimo o un minimo?

3. Prescindendo dalla questione geometrica si studi la funzione $f(x) = \dfrac{3V(x)}{2\pi}$ e se ne tracci il grafico $\gamma$.
...
**Soluzione:** [[Svolgimenti/sol_prob_2014_ordinamento_2014_sessione_straordinaria_problema1_134_1|📝 Svolgimento]] · [📄 PDF p.134](https://drive.google.com/file/d/1WH26K6aDhT0rm439hBww1SX_Dwrvky9g/view)
