---
title: Scuole estero Americhe 2012 — Problema 1 — Problema 1
tipo: problema
item_id: prob_2012_scuole_italiane_allestero_americhe_2012_sessione_o_problema1_14_1
...
Fonte: p.14 · [📄 Apri PDF](https://drive.google.com/file/d/15uTp-FXyM3r6gZHrCu6HThex3dLEYCIU/view)
**Prova:** [[Prove/2012_scuole_italiane_allestero_americhe_2012_sessione_o_problema1_14|Scuole estero Americhe 2012 — Problema 1]] · **Cluster:** [[Clusters/Studio di Funzione|Studio di Funzione]]
...
**2)** Si esprima in funzione di $x$ il rapporto fra l'area del triangolo $PQC$ e l'area del quadrilatero $ABQP$, verificando che si ottiene la funzione:
$$f(x)=\frac{4x^2}{3-4x^2}.$$
Il rapporto $f(x)$ assume tutti i valori reali positivi? Si giustifichi la risposta.

**3)** Si studi la funzione $f$ senza tener conto dei limiti geometrici del problema e se ne tracci il grafico $\gamma$.
...
**Soluzione:** [[Svolgimenti/sol_prob_2012_scuole_italiane_allestero_americhe_2012_sessione_o_problema1_14_1|📝 Svolgimento]] · [📄 PDF p.14](https://drive.google.com/file/d/15uTp-FXyM3r6gZHrCu6HThex3dLEYCIU/view)
