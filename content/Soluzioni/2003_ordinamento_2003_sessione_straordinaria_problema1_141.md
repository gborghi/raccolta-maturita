---
tipo: soluzione
prova_stem: 2003_ordinamento_2003_sessione_straordinaria_problema1_141
pdf: Prova_Maturita_2003.pdf
source: text
title: Soluzioni — 2003_ordinamento_2003_sessione_straordinaria_problema1_141
---
# Soluzioni — 2003_ordinamento_2003_sessione_straordinaria_problema1_141

## Problema 1

ORDINAMENTO 2003 - SESSIONE STRAORDINARIA - PROBLEMA $1$

È assegnata la seguente equazione in $x: x^{3} + 2x-50 = 0$ .

a)

Dimostrare che ammette una e una sola soluzione x̅ nel campo reale.
...
Stabilire se fra le rette di equazione $y= 5x+ m$ , dove $m$ è un parametro reale, $ve$ ne
sono di tangenti alla curva $C^{0}$ ottenuta per $k= 0$ .

La curva $C^{0}$ ha equazione:

$y= x^{3} + 2x-50$

Tale curva è tangente alla retta data se:

$x^{3} + 2x-50 = 5x+ m$
$D(x^{3} + 2x-50) = D(5x+ m)$ {
$x^{3} -3x-50 -m= 0$
$3x^{2} + 2 = 5 \implies x= \pm 1$ quindi:

{ $x= 1$
$m= -52$ , { $x= -1$
$m= -48$

Ci sono quindi due rette, fra quelle date, tangenti alla curva $C^{0};$ esse sono:
