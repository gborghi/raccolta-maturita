---
tipo: soluzione
prova_stem: 2015_sessione_ordinaria_2015_prova_114
pdf: Prova_Maturita_2015.pdf
source: text
title: Soluzioni — 2015_sessione_ordinaria_2015_prova_114
---
# Soluzioni — 2015_sessione_ordinaria_2015_prova_114
...
Tema di: MATEMATICA, MATEMATICA E INFORMATICA
...
$5.$ Detta A(n) l’area del poligono regolare di $n$ lati inscritto in un cerchio $C$ di raggio $r,$ verificare
che A(n) $= n$
$2 r2sen2\pi$
$n$ e calcolarne il limite per $n\to \infty$ .
$6.$ I lati di un triangolo misurano, rispettivamente, $6 cm, 6 cm$ e $5 cm.$ Preso a caso un punto $P$
...
$8.$ Il grafico della funzione f(x) $= \sqrt{x}⁡⁡(x\in R, x \ge 0)$ divide in due porzioni il rettangolo ABCD
