---
title: 2005 Ordinamento Straordinaria — Problema 1 — Problema 1 — Svolgimento
tipo: soluzione
item_id: >-
  sol_prob_2005_liceo_scientifico_ordinamento_2005_sessione_straor_problema1_128_1
of_item: prob_2005_liceo_scientifico_ordinamento_2005_sessione_straor_problema1_128_1
...
ORDINAMENTO 2005 - SESSIONE STRAORDINARIA - PROBLEMA $1$
...
Cerchiamo l’equazione della circonferenza circoscritta al quadrilatero AECD.

Dato che l’angolo ADC è retto, il segmento $AC$ è un diametro. Quindi il raggio $R$ è la metà
di $AC$ ed il centro è il punto medio $M$ di $AC:$

$M=$ (
$2 ; 2) ; AC= AB= 5; R=$
$2$ . Quindi la circonferenza ha equazione:

$(x-9$
$$ 2) 2 $$
$+ (y-2)^{2} = 25$
$4 , x^{2} + y^{2} -9x-4y+ 18 = 0$
