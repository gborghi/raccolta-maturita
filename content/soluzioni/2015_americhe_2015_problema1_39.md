...
Per $t=0$ risulta $y(0)=1;$ per $t=1$ risulta $y(1)=1-(1/7)y(0)=1-1/7=6/7;$
per $t=2$ risulta $y(2)=6/7-(1/7)(6/7)=(6/7)(1-1/7)=(6/7)^2$
In generale quindi: y(t) = (
$$ 6 7) t $$

Considerando la funzione continua rispetto alla variabile $t,$ si tratta di una funzione
esponenziale di base $6/7,$ il cui grafico è il seguente:
...
massimo, diminuisce abbastanza rapidamente, raggiungendo, dopo dodici ore, una
concentrazione abbastanza bassa, pari a (
$$ 6 7) 12 $$
$\cong 0.16$
$\mu g$
$ml$ .
Nel caso della somministrazione intramuscolare, come detto nella premessa, il farmaco
viene dapprima iniettato nel muscolo e progressivamente passa nel sangue, pertanto si
può ipotizzare che la sua concentrazione nel sangue aumenti per un certo tempo e, in
particolare, con la legge in esame, raggiunge il massimo dopo circa $5.89$ ore, massimo
che è uguale a circa $0.43$
$\mu g$
$ml;$ dopo aver raggiunto tale massimo la concentrazione
diminuisce, un po’ più lentamente rispetto al caso della somministrazione endovenosa;
per esempio dopo circa $11.78$ ore (tempo relativo al flesso della curva), si ha una
concentrazione pari a circa $0.32$
$\mu g$
$ml;$ dopo lo stesso tempo, nel caso della
somministrazione endovenosa, la concentrazione è circa la metà: (
$$ 6 7) 11.78 $$
$\cong 0.16$
$\mu g$
$ml$ .
Osserviamo che le due concentrazioni sono uguali dopo un tempo $t$ corrispondente al
punto di incontro dei due grafici, pari a circa $5.47$ ore; la concentrazione comune è pari a
circa $0.43$
$\mu g$
$ml$ .

Notiamo che le derivate prime delle due funzioni indicano la velocità di variazione
...
$$ 6 7) t = ( 6 7) t $$
∙ln(
$7) < 0$ per ogni $t,$ vuol dire che la
concentrazione diminuisce sempre; infatti si è ipotizzato che raggiunga pressoché
istantaneamente la massima concentrazione.
...
Ciò vuol dire che vengono accumulati nell’organo $(6.487$ ∙k) microgrammi al millilitro di
farmaco, teoricamente in un tempo infinito, praticamente dopo circa $24$ ore. Infatti,
ponendo $b=24$ nel calcolo precedente, si ottiene circa il $98$ % del valore totale:
...
farmaco, teoricamente in un tempo infinito, praticamente dopo $24$ ore si ha:
...
$\mu g$
ml∙h (microgrammi al
millilitro), che è circa il $91%$ del totale. Dopo $48$ ore abbiamo:
...
Riepilogando, abbiamo nei due casi le seguenti quantità di farmaco accumulata
nell’organo:

Somministrazione endovenosa: $\cong (6.5$ ∙k)
$\mu g$
$ml$ ∙h (microgrammi al millilitro)
Somministrazione intramuscolare: $(7$ ∙k)
$\mu g$
ml∙h (microgrammi al millilitro)

E’ maggiore, seppur di poco, la quantità di farmaco accumulata nell’organo nel
caso della somministrazione intramuscolare.
