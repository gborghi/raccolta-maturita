---
tipo: prova
prova_id: prova_1999_estero_1999_problema1_13
anno: '1999'
...
b) Condotta per $F$ una retta di coefficiente angolare $m$, indicati con $A$ e $B$ i punti in cui tale retta seca la parabola e condotte quindi le rette tangenti alla parabola stessa in questi punti, esprimere in funzione di $m$ le coordinate del punto $P$ in cui si secano tali tangenti.

c) Verificare che il punto $P$ appartiene alla direttrice della parabola.

d) Chiamate $A'$, $B'$, $P'$ le posizioni dei punti $A$, $B$, $P$ corrispondenti al particolare valore $m = \dfrac{1}{2}$, trovare l'equazione della circonferenza passante per i punti $A'$, $B'$, $P'$.
