...
$$x^2-(k-1)x+2=0 \quad \text{con} \quad 0\le x\le 2.$$
...
$$\arcsin(\sin(-0.3))=-0.3 \qquad \arccos(\cos(-0.3))=-0.3$$
$$\sin(\arcsin(-0.3))=-0.3 \qquad \cos(\arccos(-0.3))=-0.3$$
...
Si calcoli
$$\lim_{n\to\infty}\left[\frac{1}{n!}\binom{n}{k}\right].$$
