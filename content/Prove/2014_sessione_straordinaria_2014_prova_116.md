...
$$f(\varphi)=\operatorname{sen}\varphi+\frac{5}{4}\cos\varphi$$
2. Si studi $f(\varphi)$ e se ne tracci il grafico anche prescindendo dai limiti geometrici del problema.
...
2. Si mostri che l'area della regione $\sigma$, delimitata da $\Gamma$ e dagli assi cartesiani sull'intervallo chiuso $[0,1]$ è uguale a $\ln 2-\dfrac{1}{2}$.
...
si calcoli un'approssimazione di $\dfrac{\pi}{4}$, utilizzando uno dei metodi di integrazione numerica studiati.
