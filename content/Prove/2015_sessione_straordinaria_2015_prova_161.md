...
*↳ Nota atomica: [[Problemi/prob_2015_sessione_straordinaria_2015_prova_161_1|Problema 1]]*
...
1. Individua la funzione $y(t)$ che presenta l'andamento richiesto, ipotizzando una concentrazione iniziale $y(0)=1\ \dfrac{\mu g}{ml}$ (microgrammi a millilitro) e rappresentala graficamente in un piano cartesiano avente in ascisse il tempo $t$ espresso in ore e in ordinate la concentrazione espressa in $\dfrac{\mu g}{ml}$.
...
2. Scegli tra le seguenti funzioni quella che ritieni più adatta per rappresentare l'andamento descritto per il caso della somministrazione per via intramuscolare, giustificando la tua scelta:
$$y(t)=1-\frac{(t-4)^2}{16}$$
$$y(t)=\sin(3t)\cdot e^{-t}$$
$$y(t)=-t^3+3t^2+t$$
$$y(t)=\frac{7}{2}\left(e^{-\frac{t}{7}}-e^{-\frac{t}{5}}\right)$$

3. traccia il grafico della funzione scelta in un piano cartesiano avente in ascisse il tempo $t$ espresso in ore e in ordinate la concentrazione $y$ espressa in $\dfrac{\mu g}{ml}$ e descrivi le sue caratteristiche principali, in rapporto al grafico della funzione relativa alla somministrazione per via endovenosa.

Per evitare danni agli organi nei quali il farmaco si accumula è necessario tenere sotto controllo la concentrazione del farmaco nel sangue. Supponendo che in un organo il farmaco si accumuli con una velocità $v$, espressa in $\dfrac{\mu g}{ml\cdot h}$, proporzionale alla sua concentrazione nel sangue:
$$v(t)=k\cdot y(t)$$
...
*↳ Nota atomica: [[Problemi/prob_2015_sessione_straordinaria_2015_prova_161_2|Problema 2]]*

Sia $f$ la funzione definita da $y(x)=(4x-2)\cdot e^{2x}$.
...
2. Dimostra che la funzione $g(x)=(-4x-2)\cdot e^{-2x}$ è simmetrica a $f$ rispetto all'asse $y$ e tracciarne il grafico $G_g$;
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_1|Quesito 1]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_3|Quesito 3]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_4|Quesito 4]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_5|Quesito 5]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_6|Quesito 6]]*

6. Determinare la funzione densità di probabilità di una variabile casuale continua che assume valori nell'intervallo $[2,5]$ con una distribuzione uniforme. Determinare inoltre il valore medio, la varianza, la deviazione standard di tale variabile e la probabilità che sia $\dfrac{7}{3}\le x\le\dfrac{17}{4}$.
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_7|Quesito 7]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_8|Quesito 8]]*
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_9|Quesito 9]]*

9. In un riferimento cartesiano nello spazio $Oxyz$, data la retta $r$ di equazioni:
$$\begin{cases} x=2t+1\\ y=1+t\\ z=kt\end{cases}$$
e il piano $P$ di equazione $x+2y-z+2=0$, determinare per quale valore di $k$ la retta $r$ e il piano $P$ sono paralleli, e la distanza tra di essi.
...
*↳ Nota atomica: [[Quesiti/ques_2015_sessione_straordinaria_2015_prova_161_10|Quesito 10]]*
