...
1) Dimostrare che
$$p_1(x)=(1-x)^2,\qquad p_2(x)=2x(1-x)^2,\qquad p_3(x)=x^3+3x^2(1-x)$$
...
3) Provare che esiste un unico $x_0\in[0,1]$ tale che:
$$p_1(x_0)=p_3(x_0)$$
e stabilire se vale la disuguaglianza: $x_0>1/2$.
