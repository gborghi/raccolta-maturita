...
**a)** stabilire sotto quali condizioni per i parametri reali $a$, $b$ esso è: determinato, indeterminato, impossibile.

**b)** Posto che la terna $(x; y; z)$ sia una soluzione del sistema $[1]$, studiare la curva di equazione:
