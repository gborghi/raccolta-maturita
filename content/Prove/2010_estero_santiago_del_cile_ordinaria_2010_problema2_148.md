---
tipo: prova
prova_id: prova_2010_estero_santiago_del_cile_ordinaria_2010_problema2_148
anno: '2010'
...
**a)** Si calcoli l'area di $ABDC$ in funzione di $x=AC$.

**b)** Si calcoli l'area di $ABDC$ in funzione di $\varphi=B\hat{A}C$.

**c)** Per quali valori di $x$ e di $\varphi$ l'area del quadrilatero è massima? Quanto vale tale area? Sia $T$ tale quadrilatero massimo.
