...
4. Verificato che è $\Omega=\dfrac{3}{2}(\ln 3 -1)$, si illustri una procedura numerica per il calcolo approssimato di $\ln 3$.
...
3. Quanti e quali sono gli zeri della funzione $h(x)=2^x-x^2$? Si tracci il grafico di $h$.
