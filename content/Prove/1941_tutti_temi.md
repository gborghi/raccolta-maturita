...
e discutere la realtà ed il segno delle radici al variare di $a$, che si suppone positivo. Casi particolari:

$$a=\frac{1}{2}, \quad a=1, \quad a=\frac{3}{2}, \quad a=\frac{1+\sqrt{5}}{2}.$$

È in facoltà del candidato di ritrovare i risultati della discussione per via geometrica, servendosi delle due linee (cerchio e retta) rappresentate, in coordinate cartesiane ortogonali, dalle due equazioni del sistema dato.
