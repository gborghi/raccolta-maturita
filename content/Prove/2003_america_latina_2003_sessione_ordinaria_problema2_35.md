...
*↳ Nota atomica: [[Problemi/prob_2003_america_latina_2003_sessione_ordinaria_problema2_35_1|Problema 1]]*
...
**a)** Trovate l'equazione cartesiana del luogo $\Gamma$ descritto da $Q$ al variare di $P$ su $r$.

**b)** Studiate $\Gamma$, disegnatene il grafico e spiegate con considerazioni geometriche quanto si riscontra, analiticamente, per $x=3$.

**c)** Si calcoli l'area della regione di piano racchiusa tra $\Gamma$, il suo asintoto obliquo, l'asse $y$ e la retta $x=2$.
