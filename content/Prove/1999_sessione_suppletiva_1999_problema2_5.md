---
tipo: prova
prova_id: prova_1999_sessione_suppletiva_1999_problema2_5
anno: '1999'
...
c) Considerate infine le formule: $V = \dfrac{4}{3}\pi x^3$ e $S = \pi x^2$, che danno rispettivamente il volume di una sfera di raggio $x$ e l'area di un cerchio sempre di raggio $x$, se ne illustrino i risultati della derivazione rispetto a $x$.
