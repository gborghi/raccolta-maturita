...
**Quesito 1.** Si inscriva in una semisfera di raggio $R$ il tronco di cono di massima superficie laterale, avente la base maggiore coincidente con quella della semisfera. Si assuma come incognita l'apotema del tronco di cono.
...
**Quesito 2.** Si calcoli il limite della funzione
$$\frac{\ln\big(1+\operatorname{sen}(3x)\big)}{e^{\operatorname{tg}(2x)}-1}$$
quando $x$ tende a $0$.
...
**Quesito 3.** Si dimostri che il volume di una sfera, il volume del cilindro circoscritto e il volume del cono equilatero circoscritto sono proporzionali ai numeri $4$, $6$, $9$.
...
**Quesito 5.** Si determini il valore medio della funzione $f(x)=\sqrt{2x-1}$ nell'intervallo $4\le x\le 6$.
...
**Quesito 7.** Si consideri la funzione
...
**Quesito 9.** Il $\displaystyle\lim_{n\to\infty}\frac{1+2+3+\cdots+n}{n^2}$ vale $0$. Si dica se quest'affermazione è vera o falsa e si fornisca un'esauriente spiegazione della risposta.
...
**Quesito 10.** Quali punti del grafico della funzione $f(x)=\dfrac{2}{x^2}$ hanno distanza minima dall'origine?
