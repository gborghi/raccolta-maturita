...
**Quesito 1.** È assegnato un pentagono regolare di lato lungo $L$. Recidendo opportunamente, in esso, cinque triangoli congruenti, si ottiene un decagono regolare: calcolarne la lunghezza del lato. (Si lascino indicate le funzioni goniometriche degli angoli coinvolti).
...
**Quesito 2.** Una piramide quadrangolare regolare è tale che la sua altezza è il doppio dello spigolo di base. Calcolare il rapporto fra il volume del cubo inscritto nella piramide e il volume della piramide stessa.
...
**Quesito 3.** Se le funzioni $f(x)$ e $g(x)$, entrambe tendenti a 0 quando $x\to a$, non soddisfano alle condizioni previste dal teorema di De L'Hôpital, non è possibile calcolare il limite di $\dfrac{g(x)}{f(x)}$ quando $x\to a$. È vero o è falso? Fornire un'esauriente spiegazione della risposta.
...
**Quesito 4.** Il limite della funzione $f(x) = x - \ln x$ per $x \to +\infty$ è:
...
**Quesito 5.** Dimostrare che la derivata, rispetto a $x$, della funzione $\arctan(x)$ è $\dfrac{1}{1+x^2}$.
...
**Quesito 9.** Considerata l'equazione: $\cos\dfrac{x}{2}\,\sin(2x) = 12$, spiegare in maniera esauriente se ammette soluzioni reali o se non ne ammette.
...
**Quesito 10.** Una classe è formata da 28 alunni, di cui 16 femmine e 12 maschi. Fra le femmine c'è una sola «Maria» e fra i maschi un solo «Antonio». Si deve formare una delegazione formata da due femmine e due maschi. Quante sono le possibili delegazioni comprendenti «Maria» e «Antonio»?
