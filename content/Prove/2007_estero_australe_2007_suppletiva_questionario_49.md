...
*↳ Nota atomica: [[Quesiti/ques_2007_estero_australe_2007_suppletiva_questionario_49_1|Quesito 1]]*

**Quesito 1.** Si vuole che delle due radici dell'equazione $x^2 + 2(h+1)x + m^2 h^2 = 0$ una risulti doppia dell'altra. Quale relazione deve sussistere tra i parametri $h$ e $m$?
...
*↳ Nota atomica: [[Quesiti/ques_2007_estero_australe_2007_suppletiva_questionario_49_2|Quesito 2]]*

**Quesito 2.** Sia $f(x) = x + \sin x$ per ogni $x$. Si trovino i punti $x$ in corrispondenza dei quali il grafico di $f$ in $(x, f(x))$ abbia coefficiente angolare nullo.
...
*↳ Nota atomica: [[Quesiti/ques_2007_estero_australe_2007_suppletiva_questionario_49_3|Quesito 3]]*

**Quesito 3.** La risoluzione di un dato problema conduce all'equazione
$$k\sin x + \cos x = 2k \qquad \text{ove } k \geq 0 \text{ e } 0 \leq x \leq \frac{\pi}{2}.$$
...
*↳ Nota atomica: [[Quesiti/ques_2007_estero_australe_2007_suppletiva_questionario_49_4|Quesito 4]]*

**Quesito 4.** Le nuove targhe automobilistiche sono costituite da $2$ lettere, seguite da $3$ cifre, seguite a loro volta da $2$ lettere. Sapendo che le lettere possono essere scelte tra le $26$ dell'alfabeto anglosassone, si calcoli quante automobili si possono immatricolare in questo modo.
...
*↳ Nota atomica: [[Quesiti/ques_2007_estero_australe_2007_suppletiva_questionario_49_5|Quesito 5]]*

**Quesito 5.** Si dia una definizione di poliedro regolare. Si dimostri che i poliedri regolari sono, a meno di similitudini, solo $5$ e si dica quali sono.
...
*↳ Nota atomica: [[Quesiti/ques_2007_estero_australe_2007_suppletiva_questionario_49_6|Quesito 6]]*

**Quesito 6.** Si considerino un cubo e l'ottaedro regolare avente per vertici i centri delle sue facce. Si può calcolare il rapporto fra i volumi del cubo e dell'ottaedro? In caso di risposta affermativa, effettuare il calcolo.
...
*↳ Nota atomica: [[Quesiti/ques_2007_estero_australe_2007_suppletiva_questionario_49_7|Quesito 7]]*

**Quesito 7.** Le misure dei lati di un triangolo sono $18$, $24$ e $30$ cm. Si calcolino, con l'aiuto di una calcolatrice, le ampiezze degli angoli del triangolo approssimandole in gradi e primi sessagesimali.
...
*↳ Nota atomica: [[Quesiti/ques_2007_estero_australe_2007_suppletiva_questionario_49_8|Quesito 8]]*
