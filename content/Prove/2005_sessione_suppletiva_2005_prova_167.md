...
5. Verificare che esiste un valore $a'$ di $a$ per il quale la funzione $f_{a'}(x)$ si può considerare la densità di probabilità di una variabile aleatoria continua e determinare la funzione di distribuzione di tale variabile.
