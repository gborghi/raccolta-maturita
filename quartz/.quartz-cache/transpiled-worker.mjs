    ...
    /* @__PURE__ */ jsxs("body", { "data-slug": slug, children: [
      ...
      /* @__PURE__ */ jsx4("div", { id: "quartz-root", class: "page", children: /* @__PURE__ */ jsxs(Body2, { ...componentData, children: [
        ...
        /* @__PURE__ */ jsxs("div", { class: "center", children: [
          /* @__PURE__ */ jsx4("div", { class: "page-header", children: /* @__PURE__ */ jsx4("div", { class: "popover-hint", children: beforeBody.map((BodyComponent) => /* @__PURE__ */ jsx4(BodyComponent, { ...componentData })) }) }),
...
// quartz/components/scripts/cerca.inline.ts
var cerca_inline_default = "";

// quartz/components/CercaPage.tsx
var style = `
...
`;
var CercaPage_default = /* @__PURE__ */ __name((() => {
  const CercaPage = /* @__PURE__ */ __name(() => null, "CercaPage");
  CercaPage.afterDOMLoaded = cerca_inline_default;
  CercaPage.css = style;
  return CercaPage;
}), "default");
...
var Navbar = /* @__PURE__ */ __name(({ cfg, displayClass }) => {
  const bp = basePathOf(cfg?.baseUrl);
  return /* @__PURE__ */ jsx37("nav", { class: classNames(displayClass, "navbar"), children: /* @__PURE__ */ jsxs21("div", { class: "navbar-inner", children: [
    /* @__PURE__ */ jsxs21("a", { class: "navbar-brand", href: `${bp}/`, children: [
      /* @__PURE__ */ jsx37("img", { class: "navbar-logo", src: `${bp}/static/maturita-icon.svg`, alt: "", "aria-hidden": "true" }),
      "Maturit\xE0 Scientifica"
    ] }),
    /* @__PURE__ */ jsx37("div", { class: "navbar-links", children: LINKS.map(([label, slug]) => /* @__PURE__ */ jsx37("a", { href: `${bp}/${slug}${slug === "cerca" ? "" : "/"}`, children: label })) })
  ] }) });
}, "Navbar");
Navbar.css = `
.navbar {
...
`;
var Navbar_default = /* @__PURE__ */ __name((() => Navbar), "default");

// quartz/components/scripts/pagedList.inline.ts
var pagedList_inline_default = "";

// quartz/components/PagedList.tsx
var style2 = `
...
`;
var PagedList_default = /* @__PURE__ */ __name((() => {
  const PagedList = /* @__PURE__ */ __name(() => null, "PagedList");
  PagedList.afterDOMLoaded = pagedList_inline_default;
  PagedList.css = style2;
  return PagedList;
}), "default");
...
var sharedPageComponents = {
  ...
  afterBody: [CercaPage_default(), PagedList_default()],
...
var config = {
  configuration: {
    pageTitle: "Maturit\xE0 Scientifica \u2014 Raccolta Prove",
    pageTitleSuffix: "",
    enableSPA: true,
    enablePopovers: true,
    analytics: null,
